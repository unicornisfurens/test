        ...
        <div class="inner-wrap tab-<?php echo $active_tab; ?>"><?php
          ...
          // if ( $active_tab == $default_tab ) {
            ...
            <div align="center" class="footer-notice logo-pad">
              ...
              <p>
                <b>Custom Content Shortcode</b> is developed by <a href="http://eliotakira.com" target="_blank">Eliot Akira.</a>
              </p>
              <p>
                Please visit the <a href="http://wordpress.org/support/plugin/custom-content-shortcode" target="_blank">plugin support forum</a> for any issues.
                <br>
                If you'd like to contribute to development, here is a <a target="_blank" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=T3H8XVEMEA73Y">donation link</a>.
              </p>
            </div>
            <?php
